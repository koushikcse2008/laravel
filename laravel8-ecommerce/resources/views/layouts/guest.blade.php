...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <!-- Scripts -->
        @vite(['public/vite/css/app.css', 'public/vite/js/app.js'])

        <link rel="stylesheet" href="{{ asset('vite/css/app.css') }}">
        <script src="{{ asset('vite/js/app.js') }}" defer></script>
    </head>
    <body>
							...
							<ul>
                                ...
                                @if(Route::has('login'))
                                    ...
                                    @else
                                        ...
                                        <li class="menu-item"><a title="Register" href="/register">Register</a></li>
                                    @endif
