...
<strong>What is A Listener?</strong>  <br /> <br />
...
<strong>#Step 1: Open App/Providers/EventServiceProvider.php file within $listen:</strong>  <br />
...
<strong>#Step 2: Generate an Event:</strong>  <br />
php artisan make:event LoginHistory <br /> <br />

<strong>#Step 3: Write the below code in App/Events/LoginHistory.php:</strong> <br />
public $user; <br />
...
<strong>#Step 4: Generate a Listener :</strong> <br />
...
public function handle(LoginHistory $event) <br />
    ...
    <strong>#Step 6: Create migration for login history:</strong> <br />
...
<strong>#Step 7: Run the migration file:</strong> <br />
